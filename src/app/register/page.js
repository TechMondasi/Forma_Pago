      ...
      <div className="w-full max-w-md mx-auto mt-8">
        <form className="shadow-md rounded-3xl px-8 pt-6 mb-20 border-purple-600 border-solid border-2">
          <div className="mb-4">
            ...
            <label className="block text-white text-lg font-bold mb-2" htmlFor="nombre">
              Nombre(s)
            </label>
            <input
          ...
          <div className="mb-4">
            <label className="block text-white text-lg font-bold mb-2" htmlFor="apellidos">
              Apellidos(s)
            </label>
            <input
              className="appearance-none border-b-2 border-purple-500 w-full py-2 px-3 leading-tight focus:outline-none focus:border-purple-700 bg-transparent text-white"
          ...
          <div className="mb-6 relative">
            <label className="block text-white text-lg font-bold mb-2" htmlFor="confirm-password">
