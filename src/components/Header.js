...
const Header = () => {
    return (
        <div className="z-10 max-w-full w-full flex flex-col lg:flex-row items-center justify-between text-sm p-4 lg:p-12">
            ...
            <div className="flex flex-grow justify-end gap-2 lg:gap-4 mt-4 lg:mt-0">
                <Link href='/escuelas' className="px-4 lg:px-8 py-2 lg:py-4 text-base lg:text-lg rounded-full font-semibold hover:bg-purple-600 transition ease-in delay-80 hover:scale-110">
                    Escuelas
                </Link>
                <Link href='/piloto' className="px-4 lg:px-8 py-2 lg:py-4 text-base lg:text-lg rounded-full font-semibold hover:bg-purple-600 transition ease-in delay-80 hover:scale-110">
                    Prueba Gratis
                </Link>
